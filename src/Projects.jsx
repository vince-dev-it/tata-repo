...
export default function Projects() {
  return (
    <>
      <Navbar></Navbar>
      <h1 className="text-white text-4xl font-poppins font-bold py-8 text-center animate-fade-up">
        Recent Projects
      </h1>
      <div className="grid grid-cols-1 md:grid-cols-3 place-items-baseline px-6 pb-10 font-poppins gap-8 animate-fade-up">
        {/* Card 1 */}
