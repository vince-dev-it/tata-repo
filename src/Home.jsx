    ...
    <>
      <div className="grid md:grid-cols-2 grid-cols-1 justify-center items-center px-10 mx-5 font-poppins animate-fade-up">
        ...
        <div className="flex flex-row items-center text-white">
          <div className="">
            <h1 className="lg:text-4xl md:text-xl text-xl md:text-left lg:text-left text-center font-bold py-8 md:py-4">
      ...
      <div className="flex flex-col justify-center items-center my-12 font-poppins">
        ...
        <p className="text-white text-md md:text-base text-xs px-10 py-10 pt-10 md:mx-40 lg:mx-40 mx-10 rounded-xl leading-relaxed bg-[#1c1c1c]">
          ...
          from Quezon City University last June 25, 2024 completing a Bachelor's
          Degree in Information Technology. During my four year study in the
          university, I have experienced all of the roles in Information
          Technology including System Documentation, Web Development, System
          Developer, UI/UX Designer and Project Management. I am hugely inclined
          in Front-End Web Development with the use of HTML, CSS and JavaScript
          along with the recent frameworks such as ReactJS. I focused all of my
          time to practice my code in Front-End Development and a some of my
          extra time for some Back-End Development with the use of MySQL queries
          in PHP. From my previous company, I was an IT Intern who manages and
          develops multiple web projects for WordPress by utilizing the right
          tool such as Elementor Pro for the design, PHP Code Snippets for other
          functions and the Ahrefs as the SEO for optimizing the webpages
          articles in the Google Search Engine. My continuous hunger for
          self-improvement has enabled me to explore all the possible skills
          that my course offers. With all of this acquired knowledge, I wanted
          to contribute whatever I can offer to my future company.
        </p>
      </div>
